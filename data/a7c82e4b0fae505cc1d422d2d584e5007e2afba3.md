...
- text: Name
- textbox: Katherine McCullough
- text: Email
- textbox: leland33@gmail.com
...
- separator
- paragraph: Deleting your account will permanently remove access, and all associated signatures and data.
- checkbox [checked]
- paragraph: I confirm my wish to delete my account and all associated data
- separator
- button "Cancel"
